...
- **Управление личностями** — импорт из Florality, логическое удаление и JSON-экспорт базы.
